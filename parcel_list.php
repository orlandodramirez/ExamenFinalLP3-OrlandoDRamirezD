	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=new_parcel"><i class="fa fa-plus"></i> Añadir Nuevo</a>
			</div>
		</div>
		<div class="card-body">
						...
						<td class="text-center">
							...
							switch ($row['status']) {
								...
								case '7':
									...
									break;
								case '8':
									echo "<span class='badge badge-pill badge-success'> Recogida</span>";
									break;
								case '9':
								...
								default:
									echo "<span class='badge badge-pill badge-info'> Artículo aceptado por paquetería</span>";
...
<script>
	$(document).ready(function(){
		...
		$('.view_parcel').click(function(){
			uni_modal("Detalles del paquete","view_parcel.php?id="+$(this).attr('data-id'),"large")
		})
	$('.delete_parcel').click(function(){
	_conf("¿Estás seguro de eliminar este paquete?","delete_parcel",[$(this).attr('data-id')])
	})
	})
