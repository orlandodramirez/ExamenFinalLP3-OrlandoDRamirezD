  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="dropdown">
   	<a href="./" class="brand-link">
        ...
        <h3 class="text-center p-0 m-0"><b>LAX COURIER</b></h3>
        <?php else: ?>
        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php 
              $status_arr = array("Artículo aceptado<br/>por paqueteria","Recogido","Enviada","En-Transito","Llegado a<br/>Destino","En salida para entrega","Listo para recoger","Entregada","Recogida","Fracasado<br/>Intento de entrega");
