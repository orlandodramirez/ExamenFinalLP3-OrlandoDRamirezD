...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-body">
			...
			<?php 
			$status_arr = array("Artículo aceptado por paquetería","Recogido","Enviado","En-Tránsito","Llegó a Destino","En salida para entrega","Listo para recoger","Entregada","Recogido","Intento de entrega fallida"); ?>
				...
				<label for="date_from" class="mx-1">De</label>
                ...
                <label for="date_to" class="mx-1">A</label>
...
$('#view_report').click(function(){
	if($('#date_from').val() == '' || $('#date_to').val() == ''){
		alert_toast("Por favor seleccione las fechas primerot.","error")
		return false;
	}
	load_report()
	var date_from = $('#date_from').val()
