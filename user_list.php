	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_user"><i class="fa fa-plus"></i> Agregar Nuevo Usu</a>
			</div>
		</div>
		<div class="card-body">
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a class="dropdown-item view_user" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Vista</a>
	...
	function delete_user($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Datos eliminados con exito",'exito')
					setTimeout(function(){
						location.reload()
					},1500)
