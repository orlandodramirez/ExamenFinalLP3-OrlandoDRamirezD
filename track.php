	...
	<div class="card card-outline card-primary">
		<div class="card-body">
			<div class="d-flex w-100 px-1 py-2 justify-content-center align-items-center">
				<label for="">Introduzca el número de seguimiento</label>
				<div class="input-group col-sm-5">
                    <input type="search" id="ref_no" class="form-control form-control-sm" placeholder="Escriba el número de seguimiento aquí">
	...
	function track_now(){
		...
		if(tracking_num == ''){
			...
			$.ajax({
				...
				error:err=>{
					console.log(err)
					alert_toast("Se produjo un error",'error')
					end_load()
				},
				success:function(resp){
					if(typeof resp === 'object' || Array.isArray(resp) || typeof JSON.parse(resp) === 'object'){
						...
						alert_toast('Número de seguimiento desconocido.',"error")
					}
				}
				,complete:function(){
					end_load()
