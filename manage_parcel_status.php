<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			<label for="">Estado de actualización</label>
			<?php $status_arr = array("Artículo aceptado por paquetería","Recogido","Enviado","En-Tránsito","Llegó a Destino","En salida para entrega","Listo para recoger","Entregada","Recogido","Intento de entrega fallida"); ?>
	...
	$('#update_status').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("El estado del paquete se actualizó correctamente",'éxito');
					setTimeout(function(){
						location.reload()
					},750)
				}
